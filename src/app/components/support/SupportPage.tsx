    ...
    const faqs = [
        {
            ...
            answer: "FLOCUT은 AI 기반 문서 및 음성 통합 분석 플랫폼입니다. 방대한 문서를 핵심 요약하고, 버전별 차이점을 비교하며, 논리 구조에 대한 실시간 피드백을 제공합니다."
        },
        {
            id: 2,
            category: "features",
        ...
        },
        {
            ...
            answer: "모든 파일은 암호화되어 전용 보안 저장소에 저장되며, 처리 후에는 사용자가 원할 경우 즉시 삭제됩니다. 개인정보와 데이터 보안을 최우선으로 관리합니다."
        },
        {
            id: 7,
            category: "general",
            question: "서비스 이용 요금은 어떻게 되나요?",
            answer: "FLOCUT은 현재 프로젝트 단계로 모든 기능을 무료로 제공하고 있습니다. 누구나 제한 없이 지능형 문서 분석 기능을 이용하실 수 있습니다."
        },
        {
            id: 8,
            category: "features",
            question: "음성 파일은 어떻게 처리되나요?",
            answer: "고도화된 STT(Speech-to-Text) 엔진을 사용하여 음성을 텍스트로 변환한 후, 자동으로 요약하고 구조화합니다. 회의록이나 인터뷰 기록 등을 정교하게 정리해 드립니다."
        },
        {
            id: 9,
            category: "general",
        ...
        },
        {
            ...
            answer: "네, 요약의 상세 수준을 선택할 수 있으며, 키워드 중심의 요약 또는 전체 맥락을 유지하는 요약 중 목적에 맞는 방식을 선택할 수 있습니다."
        },
        {
            id: 11,
            category: "security",
            question: "데이터는 얼마나 오래 보관되나요?",
            answer: "업로드된 파일과 분석 결과는 사용자가 삭제하기 전까지 안전하게 보관됩니다. 삭제 요청 시 서버에서 즉시 완전히 제거되어 복구가 불가능합니다."
        },
        {
            id: 12,
            category: "features",
            question: "여러 언어를 지원하나요?",
            answer: "현재 한국어를 기반으로 최적의 성능을 제공하며, 영어 문서에 대한 분석도 지원합니다. 향후 지원 언어를 지속적으로 확대할 예정입니다."
        }
    ];
