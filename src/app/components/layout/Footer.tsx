        ...
        >
            <div className="mx-auto max-w-7xl px-6 py-16">
              ...
              "
                        ...
                        <p className="text-sm text-text-muted-light dark:text-text-muted-dark leading-relaxed max-w-md">
                  ...
                  "
                                    aria-label={item}
                                >
                                    <span className="text-xs font-medium">{item[0]}</span>
                                </button>
                            ))}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {["문서 요약", "음성 요약", "문서 비교", "AI 피드백", "가격 안내"].map((item) => (
                                <li key={item}>
                                    <a
                                        href="#"
                                        className="
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {["회사 소개", "공지사항", "채용", "파트너십", "문의하기"].map((item) => (
                                <li key={item}>
                                    <a
                                        href="#"
                                        className="
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="text-xs text-text-muted-light dark:text-text-muted-dark space-y-1 text-center md:text-left">
                        ...
                        <p>주소: 서울특별시 구로구 디지털로 | 이메일: flocut2026@gmail.com</p>
                    </div>
