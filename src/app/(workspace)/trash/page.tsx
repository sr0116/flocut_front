...
import { useAllDeletedNotes } from "@/hooks/notes/useAllDeletedNotes";
...
export default function GlobalTrashPage() {
    ...
    const { notes, loading, refetch, page: pageData } = useAllDeletedNotes(currentPage, 20);
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-text-muted-light dark:text-text-muted-dark">
                                {pageData?.totalElements ?? 0}개의 삭제된 노트
                            </p>
                        </div>
                    </div>
        ...
        <div className="flex items-center gap-4 px-4 py-3 rounded-lg border border-border-light dark:border-border-dark bg-white dark:bg-surface-dark hover:bg-surface-light dark:hover:bg-surface-input transition-colors">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 text-xs text-text-muted-light dark:text-text-muted-dark">
                    <span>세션 ID: {note.sessionId}</span>
                    <span>•</span>
                    <span>
                        삭제일:{" "}
